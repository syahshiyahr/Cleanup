...
public class CleanOrNotFragment extends Fragment {
    ViewPager viewPager;
    TabLayout tabLayout;
    ImageView btnBack;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_clean_or_not, container, false);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CleanFragment(), "Clean Beach");
        adapter.addFragment(new DirtyFragment(), "Dirty Beach");
