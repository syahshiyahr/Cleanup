        ...
        client.newCall(request).enqueue(new Callback() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try{
                            ...
                            if (myResponse.equals("success")){Toast.makeText(ReportNotCurrentActivity.this, "Successful to connect to Server!", Toast.LENGTH_SHORT).show();}
                        } catch (IOException e){
                            e.printStackTrace();
                        }
                    }
            ...
            public void onFailure( Call call,  IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(ReportNotCurrentActivity.this, "Failed to connect to Server!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
